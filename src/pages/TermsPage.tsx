...
import { termsBlocks, type LegalBlock } from '../termsData'

interface Props {
  navigate: (page: Page, data?: unknown) => void
}

// Renders the real Terms & Conditions text extracted from rafikihub.com's
// terms-and-conditions.php (RafikiHub, trading as Sio Bahati Holdings Ltd).
// The Rooms & Studios Terms and COVID-19 Guidelines for Hiring Rooms &
// Studios sections are intentionally left out, consistent with dropping
// Rooms & Studios from this build.
    ...
    <div style={{ background: t.bg }}>
      <section className="pt-40 pb-16 px-6 md:px-16 lg:px-24 rh-pattern-hero" style={{ backgroundColor: t.bg2 }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-sm" style={{ color: t.subtle, fontFamily: 'var(--font-sans)' }}>
            RafikiHub, trading as Sio Bahati Holdings Ltd. Registered in the Republic of Kenya, Company Number PVT-ZQUAMRQ.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 md:px-16 lg:px-24">
        <div className="max-w-3xl mx-auto">
          <LegalBody blocks={termsBlocks} />
        </div>
        <div className="max-w-3xl mx-auto mt-16 pt-8 border-t text-center" style={{ borderColor: t.border }}>
          <button onClick={() => navigate('privacy')} className="text-sm font-semibold underline underline-offset-4" style={{ color: t.terra, fontFamily: 'var(--font-sans)' }}>
